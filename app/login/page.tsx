  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="w-full max-w-md p-8 bg-white rounded-lg shadow">
        ...
        <p className="mt-4 text-xs text-gray-500 text-center">Demo credentials: <code className="bg-gray-100 px-1">admin</code> / <code className="bg-gray-100 px-1">admin123</code></p>
      </div>
    </div>
  );
}
